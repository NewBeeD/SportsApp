...
const InlineTableLegend = () => {
  ...
  if(page === 'Homepage'){
    ...
    return (
      ...
      <Typography sx={{ fontWeight: 900, paddingTop: {xs: 1,sm: 5}}}>DFA Premier League Women Standings</Typography>


      {womenTable ? <TableContainer component={Paper} sx={{ marginTop: {xs: 2}}} >

          <Table >

            <TableHead sx={{ backgroundColor: `var(--color-color2, ${theme.colors.color2})`}}>
              <TableRow key="header-women">
                {/* <TableCell sx={{ fontSize: {xs: 8}, fontWeight: 900}}>Pos</TableCell> */}
