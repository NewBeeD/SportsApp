...
//     const categories = {
//       'GK': { label: 'Goalkeeper', color: 'error' },
//       'CB': { label: 'Defender', color: 'warning' },
//       'LB': { label: 'Defender', color: 'warning' },
//       'RB': { label: 'Defender', color: 'warning' },
//       'CDM': { label: 'Midfielder', color: 'info' },
//       'CM': { label: 'Midfielder', color: 'info' },
//       'CAM': { label: 'Midfielder', color: 'info' },
//       'LW': { label: 'Forward', color: 'success' },
//       'RW': { label: 'Forward', color: 'success' },
//       'ST': { label: 'Forward', color: 'success' },
//       'CF': { label: 'Forward', color: 'success' }
//     }
//     return categories[position] || { label: position, color: 'default' }
//   }
