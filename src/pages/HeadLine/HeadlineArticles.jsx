...
import HeadLineDisplay from "../../modules/Headlines/HeadlineDisplay"
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const apiUrl = `https://strapi-dominica-sport.onrender.com/api/headline-features/${id}?${queryString}`;
        ...
        console.error('Error loading headline feature:', error);
      }
            ...
            (
              ...
              <Box>
                ...
                {articles.RichText && articles.RichText === 'none'? <Box marginTop={4} paddingTop={4}>
                  <Typography style={{ color: `var(--color-color1, ${theme.colors.color1})`}} variant="h4" sx={{ textAlign: 'left'}}>
